...
c
      ...
      double precision pmass(nexternal),ptt(0:3)
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
c       Chosen scale corresponds to half of the mass of the final state
          do i=0,3
            ptt(i) = 0d0
            do ipart=3,nexternal
              ptt(i) = ptt(i) + P(i,ipart)
            enddo
          enddo
          
          rscale = dsqrt(dot(ptt,ptt))/2d0
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
